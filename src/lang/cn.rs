...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [远程控制 Input] 服务开启。"),
        ...
        ("verify_rustdesk_password_tip", "验证 远程控制 密码"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，远程控制 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 远程控制 窗口打开时允许连接"),
